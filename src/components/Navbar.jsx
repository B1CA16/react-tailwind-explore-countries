...
const Navbar = () => {
  return (
    <div className='flex justify-between items-center py-4'>
      ...
      <p className='text-neutral-400 hidden  sm:block'>Made using <a href='https://restcountries.com/'>restcountries.com</a> and <a href='https://unsplash.com/'>unsplash.com</a></p>
    </div>
  )
}
